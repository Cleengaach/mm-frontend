...
const UsingDSG = ({ data }) => {
  ...
  const seo = {
    ...
    metaDescription: data.strapiRoute.description.data.description,
        ...
        <div className={show === true ? "tour_detail" : "tour_detail tour_detail--map"}>
          ...
          {data.strapiRoute.mapJson ?
            <div className="tour_detail_content_column tour_detail_content_map">
              ...
              <MapWrap data={data.strapiRoute.mapJson} region={data.strapiRoute.region.title} mountain={data.strapiRoute.mountain} />
            </div>
            : null}


          {data.strapiRoute.mapJson.features.length > 0 ?
            <div className="tour_detail_content_column">
              <h4>
                Výškový profil
              </h4>
